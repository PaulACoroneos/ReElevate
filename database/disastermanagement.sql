...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 07, 2018 at 06:02 PM
...
CREATE TABLE IF NOT EXISTS `business_form` (
...
CREATE TABLE IF NOT EXISTS `donor_type` (
  `donor_id` int(8) NOT NULL,
  `volunteer_option` int(8) NOT NULL,
  `organization_option` int(8) NOT NULL,
  PRIMARY KEY (`donor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Constraints for table `business_form`
--
ALTER TABLE `business_form`
  ADD CONSTRAINT `business_form_ibfk_1` FOREIGN KEY (`contact_info_fk`) REFERENCES `contact_info` (`contact_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `business_form_ibfk_3` FOREIGN KEY (`disaster_fk`) REFERENCES `disaster_type` (`disaster_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `business_form_ibfk_4` FOREIGN KEY (`resource_fk`) REFERENCES `resource_type` (`resource_id`);
...
ALTER TABLE `volunteer_form`
  ...
  ADD CONSTRAINT `volunteer_form_ibfk_5` FOREIGN KEY (`day_fk`) REFERENCES `day` (`day_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `volunteer_form_ibfk_6` FOREIGN KEY (`organization_name_fk`) REFERENCES `organization_name` (`org_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `volunteer_form_ibfk_7` FOREIGN KEY (`resource_fk`) REFERENCES `resource_type` (`resource_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `volunteer_form_ibfk_8` FOREIGN KEY (`address_fk`) REFERENCES `address` (`address_id`) ON UPDATE CASCADE;
COMMIT;
